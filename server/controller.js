...
// Require the sequelize package and save it to a variable called Sequelize
const Sequelize = require('sequelize')

// Initialize a new Sequelize instance, passing in your connection string and an object
